        ...
        return (
            <div className="foodItem">
                ...
                <div className="edit-button">
                    <FilterLink filter={this.props.type === "dish" ? modalVisibilityFilters.SHOW_EDIT_DISH : modalVisibilityFilters.SHOW_EDIT_DRINK} currentMenuItem={this.props} currentMenu={this.props.currentMenu}><IconEditGrey/></FilterLink>
                </div>
            </div>
        )
    }
